...
const style = {
    ...
    cardsectionheader:"text-lg font-bold tracking-tight text-gray-900 text-left",
    ...
    return(
        <div>
            ...
            <div className={style.card}>
                ...
                <p className={style.cardsectionheader}>Dance</p>
                <p className={style.cardtext}>-  You can perform basic dance steps like peter pan and cross steps</p>
                <p className={style.cardsectionheader}>Freestyle</p>
